...
<section class="search-form">
    <form action="" method="POST">
        <input type="text" class="box" placeholder="пошук ..." name="search_box">
        <input type="submit" class="btn" value="Пошук" name="search_btn">
    </form>
</section>
   ...
   <div class="box-container">
      ...
      <?php
        if(isset($_POST['search_btn'])){
         ...
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE name LIKE '%{$search_box}%'") or die('запит не вдался');
