...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `users` WHERE id = '$delete_id'") or die('запит не вдался');
...
<section class="users">
   ...
   <div class="box-container">
      <?php
         $select_users = mysqli_query($conn, "SELECT * FROM `users`") or die('запит не вдался');
      ...
      <div class="box">
         ...
         <a href="admin_users.php?delete=<?php echo $fetch_users['id']; ?>" onclick="return confirm('Видалити користувача?');" class="delete-btn">Видалити</a>
      </div>
      <?php
         }
      }
